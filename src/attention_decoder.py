...
def attention_decoder(decoder_inputs, initial_state, encoder_states, enc_padding_mask, cell, initial_state_attention=False, use_coverage=False, prev_coverage=None):
  """
  Args:
    decoder_inputs: A list of 2D Tensors [batch_size x input_size]. (input_size is usually word embedding size, since the inputs to decoder are word vectors)
...
def linear(args, output_size, bias, bias_start=0.0, scope=None):
  ...
  Args:
    args: a 2D Tensor or a list of 2D, batch x n, Tensors. Or a LSTMStateTuple.
